...
# -----------------------------------------------------------------------------
alias update='sudo dnf5 check-update --refresh' # Comprobar actualizaciones
alias upgrade='sudo dnf5 upgrade --refresh -y'  # Actualizar sistema
alias install='sudo dnf5 install'               # Instalar (seguro, sin -y)
