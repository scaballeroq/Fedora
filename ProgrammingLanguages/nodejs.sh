...
echo "ℹ️ Instalando dependencias de compilación con DNF5..."
sudo dnf5 install -y gcc gcc-c++ make gdbm-devel ncurses-devel zlib-devel bzip2-devel openssl-devel || true
